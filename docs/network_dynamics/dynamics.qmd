...
# Simulate both (bare dynamics — no network setup needed)
result_default = solve(fhn_default, Euler(), t0=0.0, t1=100.0, dt=0.1)
result_with_aux = solve(fhn_with_aux, Euler(), t0=0.0, t1=100.0, dt=0.1)
