...
TVBOptim provides several canonical dynamics models. Let's start with the Lorenz system - a well-known chaotic attractor useful for testing and demonstrating core concepts.
...
dynamics.plot(t0=0.0, t1=30.0, dt=0.01, n_nodes=1, figsize=(12, 6))
```
...
TVBOptim includes several canonical models from computational neuroscience:
