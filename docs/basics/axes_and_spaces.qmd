...
# Prepare once. The returned config carries config.noise.key.
n_nodes = 8
network = Network(
...
solve_fn, base_cfg = prepare(network, Heun(), t0=0.0, t1=10.0, dt=0.1)

# Attach the axes directly to the config — the leaves they target are
