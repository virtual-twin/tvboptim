...
if HAS_TVBO:
    ...
    print("⚠ TVB-O not available. Install with: pip install tvbo")
```
...
if HAS_TVB and HAS_TVBO:
    ...
    print("⚠ Classic TVB and TVB-O both required. Install with:")
    if not HAS_TVB:
        print("  pip install tvb-library")
    if not HAS_TVBO:
        print("  pip install tvbo")
```
:::
